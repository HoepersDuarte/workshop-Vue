          ...
          <div class="card-body">
            <form>
              <div class="form-group">
                ...
                <input type="text" id="name" class="form-control" placeholder="Seu nome" v-model.trim="name">
              </div>
              <div class="form-group">
                <label for="email">Endereço de email</label>
                <input type="email" id="email" class="form-control" placeholder="Seu email" v-model.trim="email" >
              </div>
              <div class="form-group">
                <label for="password">Senha</label>
                <input type="password" id="password" class="form-control" placeholder="Senha" v-model.trim="password" >
              </div>
              <div class="form-group">
                <label for="password-confirm">Confirmação de Senha</label>
                <input type="password" class="form-control" id="password-confirm" placeholder="Confirmação de senha" v-model.trim="passwordConfirm" @keyup.enter="register" >
              </div>
              <button type="button" class="btn btn-orange btn-block" :disabled="isSaving" @click="register" >Cadastrar</button>
            </form>
          </div>
        </div>
